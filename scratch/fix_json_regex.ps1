...
$speechPath = "c:\Users\Willy\OneDrive\Desktop\Archivo-Blindado\scratch\correct_speech.txt"
...
# Regex pattern to match the "contenido" field of the speech article
$pattern = '(?s)("id":\s*"A_R_04-05_06_discurso_ricardo_flores_magon"[\s\S]*?"contenido":\s*")[\s\S]*?("\s*\},)'
